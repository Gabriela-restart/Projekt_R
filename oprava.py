      ...
      quit()
        ...
        for index, analyzovany_text in enumerate(TEXTS, start=1):  # print(f"{index}. {analyzovany_text}")       
            ...
            if cislo_textu_int == index: 
                ...
                # analyzovany_text = TEXTS[index-1]
                # print(cislo_textu_int) 
                # print(analyzovany_text)
                jednotliva_slova = analyzovany_text.split()
                # print(f"slova:", jednotliva_slova)
                
                for slovo in jednotliva_slova:  #  Spočítá následujícíc statistiky                          
